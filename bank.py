...
Sujon = admin.create_account('Sujon', 2000)

Akash = admin.create_account('Akash', 1000)

Sujon.deposit(bank, 5000)

print(Sujon.check_balance())
print(Akash.check_balance())

Sujon.withdraw(bank, 1000)
Sujon.transfer(Akash, 500)

admin.enable_loan_feature()

Sujon.take_loan(bank, 1000)
...
transaction_history = Sujon.get_transaction_history()
